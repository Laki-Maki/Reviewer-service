...
В терминах кода это значит: при выборе 2 ревьюверов мы смотрим на количество PR, где человек уже назначен как reviewer, и сначала выбираем тех, у кого это число минимальное.

Если несколько кандидатов имеют одинаковую минимальную нагрузку, то среди них делаем случайный выбор (тiebreaker).